...
// you need to modify these to intercept the calls...
function razInsert(s) {
   try {
     razInvoke ('/mutant/robot/razKeyboard?key='+s+'&state='+false)
   } catch(e) {}
}
function razModify(s,b) {
   try {
     razInvoke ('/mutant/robot/razKeyboard?key='+s+'&state='+b)
   } catch(e) {}
}

var VKI_attach, VKI_close, razShow;
  function VKI_buildKeyboardInputs() {
    ...
    this.VKI_imageURI = "/mutant/public/keyboard.png";
    ...
    this.VKI_modify = function(type) {
      switch (type) {
        case "Alt":
        case "AltGr": this.VKI_altgr = !this.VKI_altgr; razModify("Alt", this.VKI_altgr); break;
        case "AltLk": this.VKI_altgrlock = !this.VKI_altgrlock; break;
        case "Caps": this.VKI_shiftlock = !this.VKI_shiftlock; razModify("Caps", this.VKI_shiftlock); break;
        case "Shift": this.VKI_shift = !this.VKI_shift; razModify("Shift", this.VKI_shift); break;
      } var vchar = 0;
  ...
  this.VKI_attachKeyboard(newdiv);
  this.VKI_show(newdiv);

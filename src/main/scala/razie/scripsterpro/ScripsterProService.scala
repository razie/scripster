...
object Pro {
  lazy val notice = Comms.readStream (this.getClass().getResource("/public/scripsterpro/scripster-view.html").openStream)
  lazy val blahblah = Comms.readStream (this.getClass().getResource("/public/scripsterpro/scripsterpro-blahblah.html").openStream)
